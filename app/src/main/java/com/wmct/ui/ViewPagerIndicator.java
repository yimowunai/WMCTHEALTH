...
public class ViewPagerIndicator extends LinearLayout {
    public final static String TAG = "ViewPagerIndicator";
    /**
     * 控件的宽度
     */
    private int mWidth;
     ...
     * 标题正常时的颜色
     */
    private static final int COLOR_TEXT_NORMAL = 0x77008B8B;
    /**
     * 标题选中时的颜色
     */
    private static final int COLOR_TEXT_HIGHLIGHTCOLOR = 0xFF008B8B;
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        mPaint.setColor(Color.parseColor("#ff008B8B"));
        mPaint.setStyle(Style.FILL);
        mPaint.setPathEffect(new CornerPathEffect(3));
        Log.i(TAG, "new ViewPagerIndicator------------->");
        this.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            @Override
            public void onGlobalLayout() {
                mWidth = ViewPagerIndicator.this.getWidth();
                Log.i(TAG, "mWidth------------->" + mWidth + "getScreenWidth()------------->" + getScreenWidth());
            }
        });
    }
