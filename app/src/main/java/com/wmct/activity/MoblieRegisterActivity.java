...
public class MoblieRegisterActivity extends Activity implements View.OnClickListener {

    public final static String TAG = "MoblieRegisterActivity";
    ...
    private void getAuthcode() {
        ...
        if (!CheckUtil.isMobileNO(phone)) {
            ToastUtil.showToastShort(this, R.string.check_mobileNo_format_error);
        } else {
            ...
            HealthNetAPI.msgRegistVerification(phone, authcode, new Request.RequestListener<JSONObject>() {
                        ...
                        public void onComplete(int stateCode, JSONObject result, String msg) {
                            ...
                            time.start();
                            ToastUtil.showToastLong(MoblieRegisterActivity.this, StringUtil.ENChangeToCH(JsonToBean.getMsg(result)));
    ...
    private void checkAuthcode() {
        //检查验证码 if(true){isAnthcodeCorrect = ture}else{错误类型}
        ...
        if (isMobileNoCorrect && isAnthcodeCorrect) {
            ...
            intent.setClass(MoblieRegisterActivity.this, UserInfoRegisterActivity.class);
